...
def volumetric_rendering(rgb, sigma, z_vals, dirs, white_bkgd):
    ...
    dists = jnp.concatenate(
        [
            ...
            jnp.broadcast_to(jnp.array(1e10), z_vals[Ellipsis, :1].shape), #! TypeError: broadcast_to requires ndarray or scalar arguments, got <class 'list'> at position 0. -- change [1e10] to jnp.array(1e10)
        ],
        -1,
    )
